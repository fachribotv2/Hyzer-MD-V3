...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        let wm = wm,
        let web = web,
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: `Selamat ${salam} ${name}`, body: '𝙁𝙖𝙘𝙝𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 あ', sourceUrl: 'https://fachriweb.vercel.app', thumbnail: data }}, options })
    }
